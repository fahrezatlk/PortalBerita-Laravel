            ...
            <div class="card full-height">
                <div class="card-header">
                    <div class="card-head-row">
                        ...
                        <a href="{{route('materi.index')}}" class="btn btn-warning btn-sm ml-auto"><i class="fas fa-undo"></i>Kembali</a>
                    </div>
                </div>
                <div class="card-body">
                    <form method="post" action="{{route('materi.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <button class="btn btn-danger btn-sm" type="reset">Ulangi</button>
                        </div>
                    </form>
                </div>
            </div>

<script src="{{asset('back/js/core/jquery.3.2.1.min.js')}}"></script>
	...
	<!-- Chart JS -->
	<script src="back/js/plugin/chart.js/chart.min.js"></script>

	<!-- jQuery Sparkline -->
	<script src="back/js/plugin/jquery.sparkline/jquery.sparkline.min.js"></script>

	<!-- Chart Circle -->
	<script src="back/js/plugin/chart-circle/circles.min.js"></script>
	...
	<!-- jQuery Vector Maps -->
	<script src="back/js/plugin/jqvmap/jquery.vmap.min.js"></script>
	<script src="back/js/plugin/jqvmap/maps/jquery.vmap.world.js"></script>

	<!-- Sweet Alert -->
	<script src="back/js/plugin/sweetalert/sweetalert.min.js"></script>

	<!-- Atlantis JS -->
	<script src="back/js/atlantis.min.js"></script>
